...
public interface BoardService {
  ...
  void write(BoardDTO boardDTO, MemberDTO memberDTO) throws DataAccessException, IOException;
  void update(BoardDTO boardDTO, MemberDTO memberDTO) throws DataAccessException, AccessDeniedException, IOException;
