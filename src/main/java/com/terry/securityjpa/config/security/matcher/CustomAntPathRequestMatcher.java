package com.terry.securityjpa.config.security.matcher;
...
public class CustomAntPathRequestMatcher implements RequestMatcher, RequestVariablesExtractor {
  ...
  protected static class SpringAntMatcher implements Matcher {
   ...
   */
  protected static class SubpathMatcher implements Matcher {
